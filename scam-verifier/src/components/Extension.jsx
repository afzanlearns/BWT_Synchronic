  ...
  return(
    <section id="extension" style={{padding:'80px 64px',maxWidth:1200,margin:'0 auto'}}>
      <div style={{borderTop:'1px solid #1e1e1e',paddingTop:64,display:'grid',gridTemplateColumns:'1fr 1fr',gap:80,alignItems:'center'}}>
        <div>
          <span style={{display:'inline-block',border:'1px solid #1e1e1e',borderRadius:999,padding:'4px 14px',fontSize:11,color:'#9a9489',fontFamily:'Sora,sans-serif',letterSpacing:'0.1em',textTransform:'uppercase',marginBottom:20}}>Chrome Extension</span>
          <h2 style={{fontFamily:'Playfair Display,serif',fontSize:'clamp(28px,3vw,42px)',fontWeight:700,color:'#f5f0e8',lineHeight:1.15,marginBottom:20,letterSpacing:'-0.02em'}}>
            Protection that<br/><em style={{fontStyle:'italic',color:'#e63946'}}>works automatically.</em>
          </h2>
          <p style={{fontFamily:'Sora,sans-serif',fontSize:14,lineHeight:1.75,color:'#9a9489',marginBottom:32,maxWidth:380}}>WhatsApp Web messages get flagged automatically. Zero clicks. Download once, protected forever.</p>
